	...
	render() {
		return (
			...
			<div className="lobby__intro">
				...
				<h2>The fun, fast race through the sum of all human knowledge!</h2> 
                <p>Race your friends between two random Wikipedia articles by clicking on cross-references.</p>
			...
			<div className="lobby__main">
				...
				<span>Wikisprint was made by <a href="http://www.github.com/ikesaunders">Ike</a>, <a href="http://www.github.com/simon2828">Simon</a> and <a href="http://www.github.com/yaroncnk">Yaron</a>.</span>
					<a href="http://github.com/decode-wiki-game/wiki-game">
						<svg className="footer__fork" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 438.529 438.529">
